...
class Target_Follower:
    def __init__(self):
        ...
        self.cmd_vel_pub = rospy.Publisher('/sita002427/car_cmd_switch_node/cmd', Twist2DStamped, queue_size=1)
        rospy.Subscriber('/sita002427/apriltag_detector_node/detections', AprilTagDetectionArray, self.tag_callback, queue_size=1)
        ################################################################
